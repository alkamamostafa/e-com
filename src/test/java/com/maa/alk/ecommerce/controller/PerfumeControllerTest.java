...
public class PerfumeControllerTest {
    ...
    public void getAllPerfumes() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(TestConstants.URL_PERFUMES_BASIC)
    ...
    public void getPerfumeById() throws Exception {
        mockMvc.perform(get(TestConstants.URL_PERFUMES_BASIC + "/1")
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getPerfumeById_ShouldNotFound() throws Exception {
        mockMvc.perform(get(TestConstants.URL_PERFUMES_BASIC + "/1111")
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    public void getReviewsByPerfumeId() throws Exception {
        mockMvc.perform(get(TestConstants.URL_PERFUMES_BASIC + "/reviews/2")
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getPerfumesByIds() throws Exception {
        mockMvc.perform(post(TestConstants.URL_PERFUMES_BASIC + "/ids")
    ...
    public void findPerfumesByFilterParams() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post(TestConstants.URL_PERFUMES_SEARCH)
    ...
    public void findByPerfumeGender() throws Exception {
        PerfumeSearchRequest filter = new PerfumeSearchRequest();
        filter.setPerfumeGender(TestConstants.PERFUME_GENDER);

        mockMvc.perform(post(TestConstants.URL_PERFUMES_SEARCH + "/gender")
                        .content(mapper.writeValueAsString(filter))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*].id").isNotEmpty())
    ...
    public void findByPerfumer() throws Exception {
        PerfumeSearchRequest filter = new PerfumeSearchRequest();
        filter.setPerfumer(TestConstants.PERFUMER_CHANEL);

        mockMvc.perform(post(TestConstants.URL_PERFUMES_SEARCH + "/perfumer")
                        .content(mapper.writeValueAsString(filter))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[*].id").isNotEmpty())
    ...
    public void getPerfumesByIdsQuery() throws Exception {
        graphQLRequest.setQuery(TestConstants.GRAPHQL_QUERY_PERFUMES_BY_IDS);

        mockMvc.perform(post(TestConstants.URL_PERFUMES_GRAPHQL + "/ids")
    ...
    public void getAllPerfumesByQuery() throws Exception {
        graphQLRequest.setQuery(TestConstants.GRAPHQL_QUERY_PERFUMES);

        mockMvc.perform(post(TestConstants.URL_PERFUMES_GRAPHQL + "/perfumes")
                        .content(mapper.writeValueAsString(graphQLRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
    ...
    public void getPerfumeByQuery() throws Exception {
        graphQLRequest.setQuery(TestConstants.GRAPHQL_QUERY_PERFUME);

        mockMvc.perform(post(TestConstants.URL_PERFUMES_GRAPHQL + "/perfume")
                        .content(mapper.writeValueAsString(graphQLRequest))
                        .contentType(MediaType.APPLICATION_JSON_VALUE))
                .andExpect(status().isOk())
